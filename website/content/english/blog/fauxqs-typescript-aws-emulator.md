...
I'm a principal software engineer at [Lokalise](https://lokalise.com/), lead maintainer of [knex.js](https://github.com/knex/knex), and creator of [node-service-template](https://github.com/lokalise/node-service-template), with about 8 years of open source experience. Prior to building fauxqs, I spent several years working on [message-queue-toolkit](https://github.com/kibertoad/message-queue-toolkit) (MQT) — a framework-style abstraction layer for message queues that provides reusable base classes, validation, error handling, and lifecycle management for building message-driven services. Basically "message queue best practices as a library" (which will be a topic of a separate blog post).
